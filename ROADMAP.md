...
- [ ] Reconcile the dewed but unmerged auth-deploy `0311457` and full-deployment `9e330e8` documentation commits only after their owning sessions confirm integration authority.
