...
- [App tabs](App-tabs.html) — persistent pinning, grouping, searches, and protected bulk close
- [Appearance editor](Appearance-editor.html) — the persisted target editor opened by menu actions
- [Regex search builder](Regex-search.html) — the bounded engine used inside every context menu
- [Command palette](Command-palette.html) — the global keyboard route to pages and settings
