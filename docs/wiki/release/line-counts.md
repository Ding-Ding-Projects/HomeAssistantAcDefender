...
The latest checked-in refresh at the `8832ffc` integration boundary reported
384 counted text files, 72,171 total lines, and 64,496 non-blank lines. CI remains
