...
The latest checked-in refresh at the `6cedbed` integration boundary reported
370 counted text files, 69,384 total lines, and 62,028 non-blank lines. CI remains
