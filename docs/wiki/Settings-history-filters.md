...
- [Settings](Settings.html) — edit the values whose snapshots appear here.
- [Appearance editor](Appearance-editor.html) — customize the settings surface without changing defender state.
- [Notification history](Notification-history.html) — review and export append-only event notices.
- [Command palette](Command-palette.html) — jump directly to the repository page and its controls.
