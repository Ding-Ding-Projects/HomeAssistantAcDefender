...
- [Command palette](Command-palette.html) — keyboard navigation and exact destinations
- [App tabs](App-tabs.html) — four independent tab searches and bulk-close previews
- [Settings history filters](Settings-history-filters.html) — date, action, and regex filters
