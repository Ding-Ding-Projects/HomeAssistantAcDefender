...
for (const marker of ["Ctrl+Shift+F", "bilingual", "funnyEnglish", "funnyCantonese", "SEARCH / REGEX BUILDER", "Guided regex blocks", "Raw pattern", "Sample text", "captures:", "Copy /pattern/flags", "Use in search", "Notification search regex builder", "Command palette regex builder", "settings-base-url", "settings-funny-en", "settings-update-feed", "focus the exact control", "role=\"tablist\"", "role=\"tabpanel\"", "aria-controls", "tabOrder", "tabAppearance", "Edit ", "Ctrl+Shift+←/→"]) if (!app.includes(marker)) throw new Error(`Missing controller feature: ${marker}`);
