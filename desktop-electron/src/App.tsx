...
function App() {
  ...
  useEffect(() => { window.controller.loadConfig().then((saved) => setConfig((current) => ({ ...current, ...saved }))).catch(() => undefined); }, []);
...
function Settings({ config, setConfig, onSave, t, regexOpen, setRegexOpen, regexMode, setRegexMode, regexPattern, setRegexPattern, regexFlags, setRegexFlags, regexError, setRegexError }: { config: ControllerConfig; setConfig: (value: ControllerConfig) => void; onSave: () => Promise<void>; t: (value: Copy) => string; regexOpen: boolean; setRegexOpen: (value: boolean) => void; regexMode: boolean; setRegexMode: (value: boolean) => void; regexPattern: string; setRegexPattern: (value: string) => void; regexFlags: string; setRegexFlags: (value: string) => void; regexError: string | null; setRegexError: (value: string | null) => void }) {
