...
function App() {
  ...
  return <main className={`app-shell ${themeClass}`} style={appearanceStyle}>
    ...
    {paletteOpen && <CommandPalette query={paletteQuery} setQuery={setPaletteQuery} onClose={() => setPaletteOpen(false)} onNavigate={(destination, focus) => { selectTab(destination); setSettingsFocus(focus || null); setPaletteOpen(false); }} t={t} />}
  </main>;
}
