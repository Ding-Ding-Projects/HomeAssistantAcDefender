...
var appTabStateTests = new AppTabStateTests();
appTabStateTests.SavedTabsAreFilteredAndCurrentPageIsOpened();
appTabStateTests.HrefsNormalizeWithoutChangingTabIdentity();
appTabStateTests.PinningGroupsAndPersistenceRoundTripWithoutDefenderState();
appTabStateTests.LegacyStringArrayStorageStillLoads();
var appTabSearchTests = new AppTabSearchServiceTests();
appTabSearchTests.FourSearchScopesStayIndependentAndRegexIsBounded();
appTabSearchTests.BulkCloseProtectsPinnedAndActiveAndSupportsInverseMatch();
appTabSearchTests.ClosingTabsKeepsAValidRouteSet();
var appContextMenuTests = new AppContextMenuPolicyTests();
appContextMenuTests.TabActionsProtectPinnedActiveAndFallbackTabs();
appContextMenuTests.EveryTargetGetsAppearanceAndLocalBoundedSearch();
appContextMenuTests.BrowserContractCoversRightClickKeyboardAndLongPress();
var regexSearchMatcherTests = new RegexSearchMatcherTests();
regexSearchMatcherTests.PlainTextRemainsAndSearchesEveryValue();
regexSearchMatcherTests.RegexFlagsAndInvalidOrOversizedPatternsAreBounded();
regexSearchMatcherTests.RegexTimeoutAndValueBoundsDoNotThrow();
var changelogCatalogTests = new ChangelogCatalogTests();
changelogCatalogTests.CatalogEntriesHaveTraceableCommits();
var changelogDateRangeTests = new ChangelogDateRangeTests();
changelogDateRangeTests.IsoInputDistinguishesEmptyPartialValidAndInvalid();
changelogDateRangeTests.PresetsAreInclusiveAndUseUtcCalendarDates();
changelogDateRangeTests.CalendarSelectionBuildsAndRestartsRanges();
changelogDateRangeTests.CalendarGridIsSixWeeksAndMondayFirst();
...
dimSumSurpriseTests.DrawRejectsInvalidBuckets();
...
var settingsHistoryFilterTests = new SettingsRepositoryHistoryFilterTests();
settingsHistoryFilterTests.ActionCountsDatesPresetsAndRegexCompose();
settingsHistoryFilterTests.ExportsAndPageContractPreserveFilteredHistory();
